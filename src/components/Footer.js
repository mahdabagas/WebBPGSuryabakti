  ...
  return (
    <>
      <footer class="w-full bg-white pt-8 relative h-fit">
        ...
        <div class="w-11/12 mx-auto md:flex justify-between gap-2 pb-20 md:w-9/12">
          <div id="kontak" class="mb-6">
            <h3 class="text-2xl font-medium text-primary text-center mb-2">
              Kontak
            </h3>
            <div class="flex pr-6 pl-4 py-2 border-2 border-primary rounded-xl w-fit gap-3 mb-2 mx-auto">
              <span>-</span>
